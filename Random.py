...
f"""{Hj}
 ...
 - instagram   : MIRWAIS DANISHYAR

 - github      : github.com/mirwaiskhulmi

 - script name : AWM 

 - version     : 1.0

 - TELEGRAM : https://t.me/AWM_TEAMPRO
...
class key:
	...
	def konfirmasi(self):
		...
		if suh in['']:
			...
			jalan ("%s•%s no whatsap saya %s: %s+93796747343 "%(U,O,M,H))

			os.system('am start https://wa.me/+93796747343?text=Assalamualaikum+saya+ingin+beli+lisensi:+'+id+'>/dev/null');jeda(1)
